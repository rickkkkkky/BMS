...
#define TIMER_FLAG_CMT                      ((uint32_t)0x00000020U)                 /*!< channel commutation flag */
...
/* configure commutation control shadow function */
void timer_channel_control_shadow_config(uint32_t timer_periph, ControlStatus newvalue);
/* configure commutation control shadow register update control */
