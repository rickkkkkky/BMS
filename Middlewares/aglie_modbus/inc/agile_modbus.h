...
#define AGILE_MODBUS_FC_READ_COILS 0x01               // 读取线圈状态
#define AGILE_MODBUS_FC_READ_DISCRETE_INPUTS 0x02     // 读取离散输入状态
#define AGILE_MODBUS_FC_READ_HOLDING_REGISTERS 0x03   // 读取保持寄存器
#define AGILE_MODBUS_FC_READ_INPUT_REGISTERS 0x04     // 读取输入寄存器
#define AGILE_MODBUS_FC_WRITE_SINGLE_COIL 0x05        // 写单个线圈
#define AGILE_MODBUS_FC_WRITE_SINGLE_REGISTER 0x06    // 写单个寄存器
#define AGILE_MODBUS_FC_READ_EXCEPTION_STATUS 0x07    // 读取异常状态
#define AGILE_MODBUS_FC_WRITE_MULTIPLE_COILS 0x0F     // 写多个线圈
#define AGILE_MODBUS_FC_WRITE_MULTIPLE_REGISTERS 0x10 // 写多个寄存器
#define AGILE_MODBUS_FC_REPORT_SLAVE_ID 0x11          // 报告从机ID
#define AGILE_MODBUS_FC_MASK_WRITE_REGISTER 0x16      // 掩码写寄存器
#define AGILE_MODBUS_FC_WRITE_AND_READ_REGISTERS 0x17 // 写和读寄存器
...
#define AGILE_MODBUS_MAX_ADU_LENGTH 260
    ...
    enum
    {
        AGILE_MODBUS_EXCEPTION_ILLEGAL_FUNCTION = 0x01, // 非法功能
        AGILE_MODBUS_EXCEPTION_ILLEGAL_DATA_ADDRESS,    // 非法数据地址
        AGILE_MODBUS_EXCEPTION_ILLEGAL_DATA_VALUE,      // 非法数据值
        AGILE_MODBUS_EXCEPTION_SLAVE_OR_SERVER_FAILURE, // 从机或服务器故障
        AGILE_MODBUS_EXCEPTION_ACKNOWLEDGE,             // 确认
        AGILE_MODBUS_EXCEPTION_SLAVE_OR_SERVER_BUSY,    // 从机或服务器忙
        AGILE_MODBUS_EXCEPTION_NEGATIVE_ACKNOWLEDGE,    // 否定确认
        AGILE_MODBUS_EXCEPTION_MEMORY_PARITY,           // 内存奇偶校验错误
        AGILE_MODBUS_EXCEPTION_NOT_DEFINED,             // 未定义
        AGILE_MODBUS_EXCEPTION_GATEWAY_PATH,            // 网关路径不可用
        AGILE_MODBUS_EXCEPTION_GATEWAY_TARGET,          // 网关目标设备无响应
        AGILE_MODBUS_EXCEPTION_UNKNOW = 0xff            // 未知错误
    };
    ...
    struct agile_modbus_slave_info
    {
        ...
        int address;             /**< 寄存器地址 */
        int nb;                  /**< 数量 */
        uint8_t *buf;            /**< 不同功能码所需的数据字段 */
        int send_index;          /**< 发送缓冲区的当前索引 */
    };
     ...
     */
    typedef int (*agile_modbus_slave_callback_t)(agile_modbus_t *ctx,
