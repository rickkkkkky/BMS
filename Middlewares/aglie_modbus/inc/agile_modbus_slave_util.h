...
typedef struct agile_modbus_slave_util {
    ...
    int nb_bits; /**< 线圈寄存器定义数组数量 */
    const agile_modbus_slave_util_map_t *tab_input_bits; /**< 离散输入寄存器定义数组 */
    int nb_input_bits; /**< 离散输入寄存器定义数组数量 */
    const agile_modbus_slave_util_map_t *tab_registers; /**< 保持寄存器定义数组 */
    int nb_registers; /**< 保持寄存器定义数组数量 */
    const agile_modbus_slave_util_map_t *tab_input_registers; /**< 输入寄存器定义数组 */
    int nb_input_registers; /**< 输入寄存器定义数组数量 */
